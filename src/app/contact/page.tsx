...
export default function Contact() {
    return (
      ...
      <Card sx={{ width: '100%', maxWidth: 600, color: "#666", backgroundColor: "#171717"   }} className='transition-all duration-300 border-2 border-transparent hover:border-red-600 hover:shadow-lg hover:shadow-red-600'>
      <CardHeader
      sx={{ 
        display: 'flex', 
        width: '100%',
        ...
        avatar={
          ...
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvCl7ij5Rv9gLNdinj7V_OrrT8sOtmsSjvxQ&s"
          aria-label="Linkedin"
          variant='circular'
          />
        }
      />
        <CardContent>
          <Typography gutterBottom component="p" className="text-1-xl text-center">
                This is my linkedin, where you can find more about me, my interests, and connections.
                <br/>
                <br/>
    ...
    hover:text-opacity-100'
         sx={{ fontSize: '1rem', color: '#666'}}>
          View My LinkedIn
            ...
            <div className="w-1/2 flex justify-center text-4xl pb-5">
            <Card 
            sx={{ width: '100%',maxWidth: 600, color: "#666", backgroundColor: "#171717"   }} 
      ...
      sx={{ 
        ...
        avatar={
          ...
          sx={{ width: 100, height: 100 }}
          className="bg-transparent"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSS6fVZfEUUaxgJebcshXae4mJhuhslt3leRg&s"
          aria-label="Linkedin"
          variant='circular'
          />
        }
