...
import { Avatar, Button, CardActions, CardHeader, CardMedia, Typography } from '@mui/material';
...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center w-1/2 pb-5" >
    <Card 
    ...
    <CardContent >
        ...
        >
        I am a boxer in training, 
        I am resilient and I am hard working when achieving personal goals.
        This lead me to improve my skills and to become a better version of myself.
        I am passionate about my work and I am always looking for new challenges.
        </Typography>
      </CardContent>
    ...
    <div className="w-1/2 flex justify-center text-4xl pb-5">
      ...
      >
        ...
        avatar={
          ...
          aria-label="github"
          variant='circular'
          src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQP0e77AwcwFRw_vPCClhU7C86OKk_v_4nhg&s'/>
        }/>
      <CardMedia
        component="img"
        height="300"
        image="https://www.shutterstock.com/shutterstock/photos/271792481/display_1500/stock-photo-code-programming-abstract-screen-of-software-developer-computer-script-red-violet-color-more-271792481.jpg"
      />
    <CardContent>
        <Typography gutterBottom component="p" className="text-center text-1xl">
        I&apos;ve been programming since 2021 and I am always looking for new challenges to improve.
        I have experience with React, Next.js, Typescript, TailwindCSS, Redux, Node.js, Express.js, MongoDB, PostMan, Github, and much more. 
        <br/><br/>
        I participated in youth programs alongside Code Differently which led me to enroll in an internship with JP.Morgan Chase,
        which honed my skills as a troubleshooter and a problem solver, solving any problem.
        I was given and tasked with the purpose of learning a new e2e technology named Cypress that is still being implemented to this day.
        <br/><br/>
        {!view && (
          <>
          <button className='text-1xl text-[#666] w-1/4 hover:w-2/5 antialiased  transition-all duration-500 hover:px-4 hover:text-[#8a0303] hover:bg-red-950 font-bold' onClick={viewMore}>
           Read More
          </button>
          </>
        )}
        {view && (
          <>          
          From there I was welcomed back into Code Differently, this time as an adult, where I was placed inside of a full-stack engineer bootcamp to 
          further improve my skills and learn new technologies, doing things such as building a full-stack application, learning new langauges and frameworks in a few days, 
          problem solving, and troubleshooting all while maintaining a strong work ethic and over a 100%. In this program I collaberated with others and personally took 
          upon a leadership role to ensure my peers were learning and growing as well.
          <br/><br/>
          In this bootcamp, I was given an externship role with a organization called Secured Health. 
          There I was tasked with Quality Assurance testing using cypress, I eventually used my knowledge and troubleshooting to code full-stack and to bring in 
          competent work that lived up to company standards and expectations.
          I was able to integrate myself into the organization and learn and grow as a developer.
          <br/><br/>
          I continue making sites and building upon what i currently have to never stop growing and to apply what I apply to boxing, a strong will and determination.
          <button 
          onClick={viewLess}
          className='text-1xl text-[#666] w-[200px] hover:w-[250px] border-2 border-red-600 hover:border-[#8a0303] antialiased  transition-all duration-500 hover:px-4 hover:text-[#8a0303] hover:bg-red-950 font-bold'
          >
            Click to view less
            </button>
          </>
    ...
    hover:text-opacity-100'
      ...
      {isVisible && (
        <button id='back-to-top' onClick={scrollToTop} className='fixed bottom-0 w-40 right-0 text-1xl text-[#666] w-auto transition-all duration-500 hover:text-[#8a0303] hover:bg-red-950 font-bold'>
          Scroll To Top
        </button>
      )}
