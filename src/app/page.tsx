          ...
          >
            ...
            <CardContent>
              ...
              >
                ...
                and to become a better version of myself. I am passionate about
                my work and I am always looking for new challenges.
              </Typography>
            </CardContent>
    ...
    hover:text-opacity-100"
        ...
        <div className="w-1/2 flex justify-center text-4xl pb-5">
          ...
          >
            ...
            />
            <CardMedia component="img" height="300" image="/coding.png" />
            <CardContent>
              <Typography
                gutterBottom
                component="p"
              ...
              >
                ...
                {!view && (
                  <>
                    <button
                      className="text-1xl text-[#666] w-1/4 hover:w-2/5 antialiased  transition-all duration-500 hover:px-4 hover:text-[#8a0303] hover:bg-red-950 font-bold"
                      onClick={viewMore}
                    >
                      Read More
                    </button>
                ...
                {view && (
                  <>
                    ...
                    organization and learn and grow as a developer.
                    <br />
