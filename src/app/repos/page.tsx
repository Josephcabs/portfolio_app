            ...
            >
              ...
              <CardContent className="text-center text-[#666]">
                ...
                <Typography component="div">
                  ...
                  <br />
                  <br />
                  with making api calls to get the data from the api and display
                  it on all the pages, styling the page and making it look good,
                  managing the database, making the cart page , checkout page ,
                </Typography>
              </CardContent>
            </Card>
          </div>
